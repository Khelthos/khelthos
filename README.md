...
<div style={{ display:'flex', flex-wrap:'nowrap' }} >
    <div style={{ justify-content: 'space-between', align-items: 'center', background-color: '#f1f1f1', width: '100px', margin: '10px', align: 'center' }}>1</div>
    <div style={{ justify-content: 'space-between', align-items: 'center', background-color: '#f1f1f1', width: '100px', margin: '10px', align: 'center' }}>2</div>
    <div style={{ justify-content: 'space-between', align-items: 'center', background-color: '#f1f1f1', width: '100px', margin: '10px', align: 'center' }}>3</div>
    <div style={{ justify-content: 'space-between', align-items: 'center', background-color: '#f1f1f1', width: '100px', margin: '10px', align: 'center' }}>4</div>
</div>
